...
class CalibrationManager:
    def __init__(self, screen: Screen, tds: TransverseDeflector, sbunches: SpecialBunchesControl) -> None:
        self.screen = screen
        self.tds = tds
        self.sbunches = sbunches
    ...
    def take_beam_off_screen(self) -> None:
        screen = self.screen
    ...
    def turn_beam_onto_screen(self) -> None:
        screen = self.screen
        position = screen.get_position()
        if position is Position.ONAXIS:
            self.turn_beam_on()
