...
from esme.gui.widgets.screen import ImagePayload, AxesCalibration
...
class ImagingControlWidget(DiagnosticSectionWidget):
    ...
    def _generate_axes_calibrations(self) -> None:
        ...
        axescalib = AxesCalibration(energy_ev=self.mreader.optics.get_beam_energy() * 1e6,
    ...
    def _set_read_frequency(self) -> None:
        ...
        self.producer_worker.submit(DataTakingMessage(MessageType.SET_FREQUENCY,
