...
class Ui_slice_analysis_gui(object):
    def setupUi(self, slice_analysis_gui):
        ...
        sizePolicy.setHeightForWidth(self.phase_space_canvas.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, slice_analysis_gui):
        ...
        self.groupBox_2.setTitle(_translate("slice_analysis_gui", "Measurement Parameters"))
        self.voltage_label.setText(_translate("slice_analysis_gui", "<i>V</i><sub>TDS</sub> / MV"))
        self.energy_label.setText(_translate("slice_analysis_gui", "<i>E</i> / MeV"))
        self.label_2.setText(_translate("slice_analysis_gui", "Time Calibration / µmps<sup>-1</sup>"))
        self.label_3.setText(_translate("slice_analysis_gui", "Energy Calibration / MeVm⁻¹"))
        self.sigma_r_label.setToolTip(_translate("slice_analysis_gui", "Screen Resolution"))
        self.sigma_r_label.setText(_translate("slice_analysis_gui", "<i>σ<sub>R</sub></i> / µm"))
        self.emittance_label.setText(_translate("slice_analysis_gui", "<i>ε</i><sub>n</sub> / mm·mrad"))
        self.screen_resolution_spinner.setToolTip(_translate("slice_analysis_gui", "Screen Resolution"))
        self.label_8.setText(_translate("slice_analysis_gui", "Screen Name"))
        self.beta_label.setText(_translate("slice_analysis_gui", "𝛽<sub><i>x</i></sub> / m"))
        self.dispersion_label.setText(_translate("slice_analysis_gui", "<i>D</i><sub><i>x</i></sub> / m"))
        self.groupBox_3.setTitle(_translate("slice_analysis_gui", "Plotting"))
        self.label_4.setText(_translate("slice_analysis_gui", "Label"))
        self.display_image_only_button.setText(_translate("slice_analysis_gui", "Show Image without Analysis"))
        self.update_label_button.setText(_translate("slice_analysis_gui", "Update Label"))
        self.plot_selected_image_button.setText(_translate("slice_analysis_gui", "Analyse Image"))
        self.label.setText(_translate("slice_analysis_gui", "Select Image"))
        self.remove_selected_image_button.setText(_translate("slice_analysis_gui", "Remove Analysis"))
        self.plot_all_button.setText(_translate("slice_analysis_gui", "Analyse All Images"))
        self.clear_plots_button.setText(_translate("slice_analysis_gui", "Clear All Analyses"))
        self.groupBox.setTitle(_translate("slice_analysis_gui", "I/O"))
        self.load_image_from_file_button.setText(_translate("slice_analysis_gui", "Load Image Collection From File..."))
        self.append_image_button.setText(_translate("slice_analysis_gui", "Append Image From Screen"))
        self.new_image_button.setText(_translate("slice_analysis_gui", "New Image From Screen"))
        self.send_to_logbook_button.setText(_translate("slice_analysis_gui", "Send to XFEL e-Logbook..."))
        self.cancel_button.setText(_translate("slice_analysis_gui", "Cancel"))
        self.images_stored_label.setText(_translate("slice_analysis_gui", "Images Stored:"))
