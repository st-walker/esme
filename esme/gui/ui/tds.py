...
class Ui_tds_control_panel(object):
    def setupUi(self, tds_control_panel):
        ...
        tds_control_panel.resize(489, 287)
        ...
        self.pushButton_2 = QtWidgets.QPushButton(tds_control_panel)
        ...
        self.pushButton_3 = QtWidgets.QPushButton(tds_control_panel)
    ...
    def retranslateUi(self, tds_control_panel):
        ...
        self.pushButton.setText(_translate("tds_control_panel", "+180°"))
        self.pushButton_2.setText(_translate("tds_control_panel", "Go to Zero Crossing"))
