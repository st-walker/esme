...
class Ui_results_box_dialog(object):
    def setupUi(self, results_box_dialog):
        ...
        sizePolicy.setHeightForWidth(
            self.beam_parameters_table.sizePolicy().hasHeightForWidth()
        )
        self.beam_parameters_table.setSizePolicy(sizePolicy)
        self.beam_parameters_table.setEditTriggers(
            QtWidgets.QAbstractItemView.NoEditTriggers
        )
        self.beam_parameters_table.setAlternatingRowColors(False)
        self.beam_parameters_table.setSelectionMode(
    ...
    def retranslateUi(self, results_box_dialog):
        ...
        self.comments_browser.setPlaceholderText(
            _translate("results_box_dialog", "Comments & Notes...", "asdasd")
        )
        self.send_to_logbook_button.setText(
            _translate("results_box_dialog", "Send To Logbook")
        )
