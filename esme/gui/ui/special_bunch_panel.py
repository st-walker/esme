...
class Ui_special_bunch_panel(object):
    def setupUi(self, special_bunch_panel):
        ...
        self.gridLayout.addWidget(self.go_to_last_bunch_in_br_pushbutton, 0, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.go_to_last_laserpulse_pushbutton, 1, 3, 1, 1)
