...
class Ui_scanner_form(object):
    def setupUi(self, scanner_form):
        ...
        self.gridLayout.addWidget(self.preferences_button, 0, 0, 1, 1)
        ...
        self.beta_setpoint_combo_box.setEnabled(False)
        ...
        self.use_known_resolution_checkbox = QtWidgets.QCheckBox(scanner_form)
        self.use_known_resolution_checkbox.setObjectName("use_known_resolution_checkbox")
        self.horizontalLayout_12.addWidget(self.use_known_resolution_checkbox)
    ...
    def retranslateUi(self, scanner_form):
        ...
        self.label_3.setText(_translate("scanner_form", "<html><head/><body><p>TDS Scan <span style=\" font-style:italic;\">D</span><span style=\" font-style:italic; vertical-align:sub;\">x</span> / m</p></body></html>"))
        self.do_beta_scan_checkbox.setText(_translate("scanner_form", "Do Beta Scan"))
        self.use_known_resolution_checkbox.setText(_translate("scanner_form", "Use Known Screen Resolution"))
