...
class Ui_scanner_form(object):
    def setupUi(self, scanner_form):
        ...
        self.line = QtWidgets.QFrame(scanner_form)
        ...
        self.emittance_label = QtWidgets.QLabel(scanner_form)
        self.emittance_label.setTextFormat(QtCore.Qt.RichText)
        self.emittance_label.setObjectName("emittance_label")
        self.horizontalLayout_9.addWidget(self.emittance_label)
        ...
        self.dscan_voltage_label = QtWidgets.QLabel(scanner_form)
        ...
        self.tds_voltages_label = QtWidgets.QLabel(scanner_form)
        ...
        self.dispersion_label = QtWidgets.QLabel(scanner_form)
        ...
        self.beta_label = QtWidgets.QLabel(scanner_form)
    ...
    def retranslateUi(self, scanner_form):
        ...
        self.emittance_label.setText(_translate("scanner_form", "<html><head/><body><p><span style=\" font-style:italic;\">ε</span><span style=\" vertical-align:sub;\">n </span>/ mm·mrad</p></body></html>"))
