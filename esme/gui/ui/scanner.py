...
class Ui_scanner_form(object):
    def setupUi(self, scanner_form):
        ...
        self.quad_scan_file_path = QtWidgets.QLabel(self.groupBox)
        self.quad_scan_file_path.setObjectName("quad_scan_file_path")
        self.horizontalLayout_9.addWidget(self.quad_scan_file_path)
    ...
    def retranslateUi(self, scanner_form):
        ...
        self.pushButton.setText(_translate("scanner_form", "Load Quad Scan..."))
        self.quad_scan_file_path.setText(_translate("scanner_form", "No File"))
        self.pushButton_2.setText(_translate("scanner_form", "Optics At Screen"))
