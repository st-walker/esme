...
class Ui_scanner_form(object):
    def setupUi(self, scanner_form):
        ...
        self.pick_slice_based_on_position_checkbox = QtWidgets.QCheckBox(
            self.groupBox_3
        )
        self.pick_slice_based_on_position_checkbox.setObjectName(
            "pick_slice_based_on_position_checkbox"
        )
        self.gridLayout_3.addWidget(
            self.pick_slice_based_on_position_checkbox, 3, 0, 1, 1
        )
        ...
        self.remeasure_dispersoin_checkbox.setObjectName(
            "remeasure_dispersoin_checkbox"
        )
        ...
        self.dispersion_scan_tds_voltage_spinbox = QtWidgets.QDoubleSpinBox(
            self.groupBox_3
        )
        self.dispersion_scan_tds_voltage_spinbox.setMaximum(5.0)
        self.dispersion_scan_tds_voltage_spinbox.setSingleStep(0.1)
        self.dispersion_scan_tds_voltage_spinbox.setObjectName(
            "dispersion_scan_tds_voltage_spinbox"
        )
        ...
        self.slice_selection_spinner.setStepType(
    ...
    def retranslateUi(self, scanner_form):
        ...
        self.pick_slice_based_on_position_checkbox.setText(
            _translate("scanner_form", "Pick Slice Based On Position")
        )
        self.do_beta_scan_checkbox.setText(_translate("scanner_form", "Do Beta Scan"))
        self.remeasure_dispersoin_checkbox.setText(
            _translate("scanner_form", "Remeasure Dispersion")
        )
        self.do_full_phase_space_checkbox.setText(
            _translate("scanner_form", "Full Phase Space")
        )
        self.dscan_voltage_label.setText(
            _translate("scanner_form", "Dispersion Scan TDS Voltage / MV")
        )
        self.tds_voltages_label.setText(
            _translate("scanner_form", "TDS Scan Voltages / MV")
        )
        self.label.setText(
            _translate("scanner_form", "Normalised Distance from Centre (±0.5)")
        )
        self.groupBox_2.setTitle(_translate("scanner_form", "Measurement Control"))
        self.background_shots_label.setText(
            _translate("scanner_form", "Background shots ")
        )
        self.beam_shots_label.setText(_translate("scanner_form", "Beam Shots"))
        self.start_measurement_button.setText(
            _translate("scanner_form", "Start Measurement")
        )
        ...
        self.measurement_name_label.setText(
            _translate("scanner_form", "Measurement Slug")
        )
        self.groupBox.setTitle(_translate("scanner_form", "Optics"))
        self.dispersion_label.setText(
            _translate(
                "scanner_form",
                '<html><head/><body><p>Screen <span style=" font-style:italic;">D</span><span style=" font-style:italic; vertical-align:sub;">x </span>/ m</p></body></html>',
            )
        )
        self.beta_label.setText(
            _translate(
                "scanner_form",
                '<html><head/><body><p>Screen <span style=" font-style:italic;">β</span><span style=" font-style:italic; vertical-align:sub;">x </span>/ m</p></body></html>',
            )
        )
        self.apply_optics_button.setText(_translate("scanner_form", "Apply"))
        self.load_quad_scan_button.setText(
            _translate("scanner_form", "Load Quad Scan...")
        )
        ...
        self.open_jddd_screen_gui_button.setText(
            _translate("scanner_form", "Open Camera JDDD...")
        )
