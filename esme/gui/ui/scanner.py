...
class Ui_scanner_form(object):
    def setupUi(self, scanner_form):
        ...
        self.gridLayout.addWidget(self.open_jddd_screen_gui_button, 7, 0, 1, 1)
        ...
        self.cycle_quads_button.setEnabled(False)
        self.cycle_quads_button.setObjectName("cycle_quads_button")
        self.gridLayout.addWidget(self.cycle_quads_button, 6, 0, 1, 1)
    ...
    def retranslateUi(self, scanner_form):
        ...
        self.open_jddd_screen_gui_button.setText(_translate("scanner_form", "JDDD Camera Panel..."))
