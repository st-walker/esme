...
class Ui_tdsfriend_mainwindow(object):
    def setupUi(self, tdsfriend_mainwindow):
        ...
        tdsfriend_mainwindow.resize(2550, 1600)
        tdsfriend_mainwindow.setMinimumSize(QtCore.QSize(2550, 1600))
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 2550, 24))
    ...
    def retranslateUi(self, tdsfriend_mainwindow):
        ...
        self.groupBox_5.setTitle(_translate("tdsfriend_mainwindow", "Beam Loss Monitors"))
