...
class Ui_tdsfriend_mainwindow(object):
    def setupUi(self, tdsfriend_mainwindow):
        ...
        tdsfriend_mainwindow.setLocale(
        ...
        self.gridLayout_8.addWidget(self.imaging_widget, 0, 0, 1, 1)
        ...
        self.verticalLayout_3.addWidget(self.beam_on_off_button)
        ...
        self.blm_stack = QtWidgets.QStackedWidget(self.groupBox_5)
        self.blm_stack.setObjectName("blm_stack")
        self.page_3 = QtWidgets.QWidget()
        self.page_3.setObjectName("page_3")
        self.gridLayout_6 = QtWidgets.QGridLayout(self.page_3)
        self.gridLayout_6.setObjectName("gridLayout_6")
        self.i1_blm_satck = QtWidgets.QWidget(self.page_3)
        self.i1_blm_satck.setObjectName("i1_blm_satck")
        self.gridLayout_6.addWidget(self.i1_blm_satck, 0, 0, 1, 1)
        self.blm_stack.addWidget(self.page_3)
        self.page_4 = QtWidgets.QWidget()
        self.page_4.setObjectName("page_4")
        self.gridLayout_5 = QtWidgets.QGridLayout(self.page_4)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.b2_blm_stack = QtWidgets.QWidget(self.page_4)
        self.b2_blm_stack.setObjectName("b2_blm_stack")
        self.gridLayout_5.addWidget(self.b2_blm_stack, 0, 0, 1, 1)
        self.blm_stack.addWidget(self.page_4)
        self.gridLayout_7.addWidget(self.blm_stack, 0, 0, 1, 1)
        ...
        self.actionBLM_Toroid_Alarm_Overview.setObjectName(
            "actionBLM_Toroid_Alarm_Overview"
        )
        ...
        self.blm_stack.setCurrentIndex(1)
    ...
    def retranslateUi(self, tdsfriend_mainwindow):
        ...
        self.groupBox_5.setTitle(
            _translate("tdsfriend_mainwindow", "Beam Loss Monitors")
        )
        ...
        self.actionBLM_Toroid_Alarm_Overview.setText(
            _translate("tdsfriend_mainwindow", "BLM && Toroid Alarm Overview")
        )
