...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lps_button = QtWidgets.QPushButton(self.controls_group_box)
        self.lps_button.setObjectName("lps_button")
        self.gridLayout_4.addWidget(self.lps_button, 8, 0, 1, 1)
        self.line = QtWidgets.QFrame(self.controls_group_box)
        ...
        self.gridLayout_4.addWidget(self.laser_heater_pushbutton, 6, 0, 1, 1)
        self.line_3 = QtWidgets.QFrame(self.controls_group_box)
        self.line_3.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_3.setObjectName("line_3")
        self.gridLayout_4.addWidget(self.line_3, 5, 0, 1, 1)
        self.line_2 = QtWidgets.QFrame(self.controls_group_box)
        ...
        self.tds_panel = TDSControl(self.controls_group_box)
        ...
        self.gridLayout_4.addWidget(self.tds_panel, 4, 0, 1, 1)
        self.bunch_length_button = QtWidgets.QPushButton(self.controls_group_box)
        self.bunch_length_button.setObjectName("bunch_length_button")
        self.gridLayout_4.addWidget(self.bunch_length_button, 9, 0, 1, 1)
        self.indicator_panel = IndicatorPanel(self.controls_group_box)
        self.indicator_panel.setObjectName("indicator_panel")
        self.gridLayout_4.addWidget(self.indicator_panel, 10, 0, 1, 1)
        self.special_bunch_panel = SpecialBunchControl(self.controls_group_box)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_4.addWidget(self.special_bunch_panel, 2, 0, 1, 1)
        self.line_4 = QtWidgets.QFrame(self.controls_group_box)
        self.line_4.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_4.setObjectName("line_4")
        self.gridLayout_4.addWidget(self.line_4, 7, 0, 1, 1)
        self.indicator_panel.raise_()
        self.laser_heater_pushbutton.raise_()
        self.special_bunch_panel.raise_()
        self.tds_panel.raise_()
        self.line.raise_()
        self.line_2.raise_()
        self.line_3.raise_()
        self.line_4.raise_()
        self.lps_button.raise_()
        self.bunch_length_button.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lps_button.setText(_translate("MainWindow", "Long. Phase Space..."))
        ...
        self.bunch_length_button.setText(_translate("MainWindow", "Measure Bunch Length..."))
