...
class Ui_hires_mainwindow(object):
    def setupUi(self, hires_mainwindow):
        ...
        self.dispersion_pixel_size_plot_widget = GraphicsLayoutWidget(self.widget)
        ...
        self.voltage_pixel_size_plot_widget = GraphicsLayoutWidget(self.widget)
        ...
        self.beta_pixel_size_plot = GraphicsLayoutWidget(self.widget)
        ...
        self.image_plot = GraphicsLayoutWidget(self.widget)
