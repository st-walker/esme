...
class Ui_hires_mainwindow(object):
    def setupUi(self, hires_mainwindow):
        ...
        self.dispersion_pixel_size_plot_widget = GraphicsLayoutWidget(
            self.centralwidget
        )
        self.dispersion_pixel_size_plot_widget.setMinimumSize(QtCore.QSize(289, 170))
        self.dispersion_pixel_size_plot_widget.setObjectName(
            "dispersion_pixel_size_plot_widget"
        )
        ...
        self.voltage_pixel_size_plot_widget.setObjectName(
            "voltage_pixel_size_plot_widget"
        )
    ...
    def retranslateUi(self, hires_mainwindow):
        ...
        hires_mainwindow.setWindowTitle(
            _translate(
                "hires_mainwindow", "High Resolution Slice Energy Spread Measurer"
            )
        )
        ...
        self.action_print_to_logbook.setText(
            _translate("hires_mainwindow", "Print to Logbook")
        )
        self.action_print_to_logbook.setShortcut(
            _translate("hires_mainwindow", "Ctrl+P")
        )
        self.actionMachine_setup.setText(
            _translate("hires_mainwindow", "Machine Setup")
        )
