...
class Ui_CurrentProfilerWindow(object):
    def setupUi(self, CurrentProfilerWindow):
        ...
        self.gridLayout_2.addWidget(self.cancel_button, 4, 2, 1, 2)
        self.progress_bar = QtWidgets.QProgressBar(self.groupBox)
        self.progress_bar.setProperty("value", 0)
        self.progress_bar.setObjectName("progress_bar")
        self.gridLayout_2.addWidget(self.progress_bar, 3, 0, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.start_measurement_button, 4, 0, 1, 2)
