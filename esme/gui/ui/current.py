...
class Ui_CurrentProfilerWindow(object):
    ...
    def retranslateUi(self, CurrentProfilerWindow):
        ...
        CurrentProfilerWindow.setWindowTitle(_translate("CurrentProfilerWindow", "MainWindow"))
        ...
        self.author_line_edit.setPlaceholderText(_translate("CurrentProfilerWindow", "xfeloper"))
        self.logbook_text_edit.setPlaceholderText(_translate("CurrentProfilerWindow", "Logbook entry..."))
        self.groupBox.setTitle(_translate("CurrentProfilerWindow", "Measurement"))
        self.start_measurement_button.setText(_translate("CurrentProfilerWindow", "Measure Current Profile"))
        self.cancel_button.setText(_translate("CurrentProfilerWindow", "Cancel"))
        self.save_raw_images_checkbox.setText(_translate("CurrentProfilerWindow", "Save Raw Images"))
